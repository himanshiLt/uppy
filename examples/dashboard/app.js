...
this.ifd0Offset: ${this.ifd0Offset}, file.byteLength: ${e4.byteLength}`), e4.tiff && await e4.ensureChunk(this.ifd0Offset, o3(this.options));
  ...
  var require_RecordingLength2 = __commonJS({
    "../packages/@uppy/audio/lib/RecordingLength.js"(exports, module) {
      "use strict";
      var _preact = (init_preact_module(), __toCommonJS(preact_module_exports));
      var _formatSeconds = require_formatSeconds2();
      function RecordingLength(_ref) {
        let {
          recordingLengthSeconds,
          i18n
        } = _ref;
        const formattedRecordingLengthSeconds = (0, _formatSeconds.default)(recordingLengthSeconds);
  ...
  var require_RecordingScreen = __commonJS({
    "../packages/@uppy/audio/lib/RecordingScreen.js"(exports, module) {
      ...
      var _RecordButton = require_RecordButton2();
      var _RecordingLength = require_RecordingLength2();
      var _AudioSourceSelect = require_AudioSourceSelect();
      var _index = require_audio_oscilloscope();
      var _SubmitButton = require_SubmitButton2();
      var _DiscardButton = require_DiscardButton2();
      function RecordingScreen(props) {
        ...
        (0, _hooks.useEffect)(() => {
          if (!recordedAudio) {
            oscilloscope.current = new _index.default(canvasEl.current, {
              canvas: {
                width: 600,
                height: 600
              },
        ...
        }, shouldShowAudioSourceDropdown ? (0, _AudioSourceSelect.default)(props) : null), (0, _preact.h)("div", {
          className: "uppy-Audio-buttonContainer"
        }, shouldShowRecordButton && (0, _preact.h)(_RecordButton.default, {
          recording,
          onStartRecording,
          onStopRecording,
          i18n
        }), hasRecordedAudio && (0, _preact.h)(_SubmitButton.default, {
          onSubmit,
          i18n
        }), hasRecordedAudio && (0, _preact.h)(_DiscardButton.default, {
          onDiscard: onDiscardRecordedAudio,
          i18n
        })), (0, _preact.h)("div", {
          className: "uppy-Audio-recordingLength"
        }, !hasRecordedAudio && (0, _preact.h)(_RecordingLength.default, {
          recordingLengthSeconds,
          i18n
        }))));
      }
  ...
  var require_Audio = __commonJS({
    "../packages/@uppy/audio/lib/Audio.js"(exports, module) {
      ...
      var _supportsMediaRecorder = require_supportsMediaRecorder2();
      var _RecordingScreen = require_RecordingScreen();
      var _PermissionsScreen = require_PermissionsScreen2();
      var _locale = require_locale14();
      function _extends() {
        _extends = Object.assign || function(target) {
          for (var i3 = 1; i3 < arguments.length; i3++) {
            var source = arguments[i3];
      ...
      var Audio2 = class extends _core.UIPlugin {
        ...
        render() {
          ...
          if (!audioState.audioReady || !audioState.hasAudio) {
            return (0, _preact.h)(_PermissionsScreen.default, {
              icon: this.icon,
              i18n: this.i18n,
              hasAudio: audioState.hasAudio
            });
          }
          return (0, _preact.h)(_RecordingScreen.default, _extends({}, audioState, {
            ...
            supportsRecording: (0, _supportsMediaRecorder.default)(),
